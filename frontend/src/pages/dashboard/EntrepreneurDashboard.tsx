...
import { apiGetMyMeetings } from '../../lib/api';
...
export const EntrepreneurDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // Load real upcoming (accepted) meetings from the backend
      apiGetMyMeetings()
        .then((res) => {
          const count = res.data.filter((m: any) => m.status === 'accepted' && new Date(m.startTime) > new Date()).length;
          setUpcomingMeetings(count);
        })
